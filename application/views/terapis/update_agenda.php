    ...
    <div class="card" style="width: 65%; margin-bottom: 100px">
        <div class="card-body">
            ...
            <?php foreach ($jadwal as $j) : ?>
                ...
                <form action="<?php echo base_url('terapis/jadwal_terapis/update_data_aksi') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="nama_pasien" class="form-control">
                            <option value="<?php echo $j->nama_pasien ?>">== Pilih Pasien ==</option>
